 ...
 <main id="main">
    ...
    <section id="pricing" class="pricing">
      <div class="container" data-aos="fade-up">
          ...
          HSK,ALLIANCE FRANCAISE,BRITISH COUNCIL</br>
          ...
          <form action="/enrollment" class="card p-3" method="post" role="form">
          ...
          <div class="form-group row mt-3">
            ...
            <div class="col-sm-2">
              <select name="gender" class="form-control"><option>select</option><option value="male">Male</option><option value="female">Female</option></select>
            </div>
          </div>
          <div class="form-group row mt-3">
          ...
          <div class="form-group row mt-3">
            ...
            <div class="col-sm-4 col-lg-4">
              <select name="course" class="form-control"><option>select</option><option value="Arabic">Arabic</option><option value="Chinese">Chinese</option><option value="English">English</option><option value="French">French</option><option value="German">German</option><option value="Italian">Italian</option><option value="Japanese">Japanese</option><option value="Spanish">Spanish</option><option value="Swahili">Swahili</option></select>
            </div>
            <label for="intake" class="col-sm-1 col-form-label">Intake</label>
            <div class="col-sm-2">
              <input type="text" name="intake" class="form-control" id="intake" >
            </div>
          </div>
